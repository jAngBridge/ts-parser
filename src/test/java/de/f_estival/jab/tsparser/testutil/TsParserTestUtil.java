...
import de.f_estival.jab.tsparser.util.TypeScriptParserFactory;
...
public class TsParserTestUtil {
    ...
    public static <T extends ParserRuleContext> T expectParseError(String input, Function<TypeScriptParser, T> ruleInvoker) {
        TypeScriptParser parser = parse(input);
...
//        });
    ...
    public static <T extends ParserRuleContext> T expectParseError(InputStream input, Function<TypeScriptParser, T> ruleInvoker) {
        TypeScriptParser parser = parse(input);
    ...
    public static <T extends ParserRuleContext> List<T> test(Function<TypeScriptParser, T> ruleInvoker, String... inputs) {
